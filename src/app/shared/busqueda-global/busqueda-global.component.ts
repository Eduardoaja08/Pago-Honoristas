...
@Component({
  ...
  template: `
    <div class="relative w-[700px] flex-1">
      <app-icon
        name="search"
      ...
      <input
        ...
        (keyup.enter)="buscar()"
        (input)="onInput()"
        class="h-9 w-[700px] rounded-lg border border-border bg-card pl-9 pr-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
